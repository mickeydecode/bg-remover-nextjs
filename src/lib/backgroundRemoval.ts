 ...
 * This runs entirely in the browser without needing API keys
 */
...
/**
 * Remove background from image using browser-based AI
 * @param imageElement - HTMLImageElement to process
